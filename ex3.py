...
while i < l:
    check = s[i:i+9]
    if check[0].islower() and check[1].isupper() and check[2].isupper() and check[3].isupper() and check[4].islower() and check[5].isupper() and check[6].isupper() and check[7].isupper() and check[8].islower():
        answer += check[4]
    i += 1
